...
import { waffle, ethers, getChainId } from "hardhat";
import { smock } from "@defi-wonderland/smock";
import { ecsign } from "ethereumjs-util";

import { ERC20, ERC20__factory } from "../types";
import { expandTo18Decimals, getApprovalDigest, bigNumberify } from "./shared/utilities";
...
describe("ERC20", () => {
    ...
    it("name, symbol, decimals, totalSupply, balanceOf, DOMAIN_SEPARATOR, PERMIT_TYPEHASH", async () => {
        ...
        expect(name).to.eq("Seth LP");
        expect(await token.symbol()).to.eq("SETH-LP");
